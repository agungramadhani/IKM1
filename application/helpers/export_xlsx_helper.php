...
function do_export_xlsx($listRespon, $simpulan, $hasil) {
	...
	try {
		...
		$worksheetReport->mergeCellsByColumnAndRow(
				...
				->setCellValueByColumnAndRow(IDX_COL_HOME+1,$rowBaseTable+1,'ID User');
		...
		$worksheetReport->mergeCellsByColumnAndRow(
				...
				->setCellValueByColumnAndRow(IDX_COL_HOME+3,$rowBaseTable+1,'Instansi');
				
		$worksheetReport->mergeCellsByColumnAndRow(
				IDX_COL_HOME+4, $rowBaseTable+1,
				IDX_COL_HOME+4, $rowBaseTable+2)
				->setCellValueByColumnAndRow(IDX_COL_HOME+4,$rowBaseTable+1,'Saran');		
		...
		foreach ($listRespon as $itemResult) {
			...
			$worksheetReport->setCellValueByColumnAndRow(
					IDX_COL_HOME+1, $currentRow, $itemResult['id_user']);
			$worksheetReport->setCellValueByColumnAndRow(
					IDX_COL_HOME+2, $currentRow, $itemResult['nama']);
			$worksheetReport->setCellValueByColumnAndRow(
					IDX_COL_HOME+3, $currentRow, $itemResult['instansi']);
			$worksheetReport->setCellValueByColumnAndRow(
					IDX_COL_HOME+4, $currentRow, $itemResult['saran']);
			$worksheetReport->setCellValueByColumnAndRow(
