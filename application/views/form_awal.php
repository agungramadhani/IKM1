<div class= "container">
	<form class="form-responden form-horizontal" method="POST" action="<?php echo base_url("save");?>" role="form" enctype="multipart/form-data">
		<a href="<?=base_url('dashboard')?>"><h4>HOME</h4></a> <h3 align="center">Formulir Registrasi Kunjungan </h3><br>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" name="nopol" value="<?php echo set_value('nopol')?>" class="form-control" placeholder="Isikan Nomor Pol responden" required autofocus />
			</div>
		</div>
