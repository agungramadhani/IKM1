<div class="container-fluid">
    <div class="row">
        < <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h3 class="page-header" style="border-bottom: solid 1px blue">Persentase Tiap Unsur</h3>
                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Jumlah Nilai Persentase Tiap Unsur</h3>
                        </div>
                            ...
                            <tbody>
                                ...
                                foreach ($unsur as $item) {
                                    echo '<tr>
                                        ...
                                        <td style="text-align:center;">' . number_format($item['persentase'], 2) . '</td>
								        </tr>';
                                }
                                ?>
                            </tbody>
